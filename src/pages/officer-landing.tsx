...
import OfficerAddTask from "./officer-add-task"; // Import the OfficerAddTask component
        ...
        <div className="org-overview grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="org-logo-container">
              <img src="path-to-your-logo-image.png" alt="Organization Logo" className="org-logo-img" />
